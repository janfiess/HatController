// inspired by the example of the esp8266 example of the library PubSubClient
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  //else if ((char)payload[1] == '2') triggerTurquoise = true;
  else if ((char)payload[1] == '2') turquoise();
  else if ((char)payload[1] == '0') black();
  else if ((char)payload[1] == '3') triggered = true;
